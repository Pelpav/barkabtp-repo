                ...
                <div class="container position-relative" data-aos="fade-up">
                    ...
                    <div class="row justify-content-center">
                        ...
                        <div class="col-lg-6">
                            ...
                            <form id="addItemForm" action="assets/php/ajouterblog.php" method="POST"
                        ...
                        <div class="col-lg-6">
                            ...
                            <div class="table-responsive">
                                <table class="table table-bordered">
                                    ...
                                    <tbody>
                                        <?php
                                        // Inclure le fichier PHP pour charger les données du blog
                                        include_once 'assets/php/loadblog.php';

                                        // Afficher les éléments du blog dans le tableau
                                        foreach ($blogItems as $item) {
                                            echo '<tr>';
                                            echo '<td>' . ucfirst(htmlspecialchars($item['author'])) . '</td>';
                                            echo '<td>' . htmlspecialchars($item['title']) . '</td>';
                                            echo '<td><img src="' . htmlspecialchars($item['image']) . '" alt="" style="max-width: 100px;"></td>';
                                            echo '<td>' . htmlspecialchars($item['description']) . '</td>';
                                            echo '<td><a href="editblog.php?id=' . htmlspecialchars($item['id']) . '">Modifier</a> | <a href="assets/php/deleteblog.php?id=' . htmlspecialchars($item['id']) . '">Supprimer</a></td>';
                                            echo '</tr>';
                                        }
